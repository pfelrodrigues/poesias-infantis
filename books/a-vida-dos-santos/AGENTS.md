...
- Ordem das peças: festa no calendário, janeiro a dezembro.
- Estados: originais `collated` até a família marcar `proofed`. Colofão `draft`.
- Mudança de data ou de ano: anotar no colofão.
